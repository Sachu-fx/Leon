...
onCommand(
  ...
  try {
   ...
   let { username, name, bio, id, location, email, url, pp, profileUrl, followers_count: followers, following_count: following, ropos_count: repos, gists_count: gists, hireable, created } = info
