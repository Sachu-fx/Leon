...
let { tguser_desc, tgchannel_desc, tggroup_desc, need_username, need_group, need_channel, user_result, group_result, channel_result } = loadLanguage();
...
onCommand(
  ...
  let caption = user_result.format(user.username, user.name, user.bio, user.dm);
...
onCommand(
  ...
  let caption = group_result.format(group.username, group.name, group.description, group.members, group.online, group.dm);
...
onCommand(
  ...
  let caption = channel_result.format(channel.username, channel.name, channel.description, channel.subscribers, channel.dm);
